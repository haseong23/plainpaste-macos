...
- **새 복사 보호** — modifier 대기나 이미지 OCR 중 ⌘C가 들어오면 늦은 붙여넣기를 취소하고, 지연된 클립보드 복원으로 새 복사를 덮어쓰지 않음
...
4. modifier 대기 또는 OCR 중 새 복사가 감지되면 예정된 붙여넣기를 취소. 지연된 원본 복원은 하지 않으며, 플레인 텍스트/OCR 결과가 클립보드에 남음
