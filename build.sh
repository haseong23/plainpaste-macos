...
swiftc -O Sources/PowerMacToysCore.swift Sources/OCREngine.swift Sources/WindowPinner.swift Sources/TextExtractor.swift Sources/SleepPreventer.swift Sources/main.swift -o "$APP/Contents/MacOS/PowerMacToys"
